    ...
    <div className="border-t border-neutral-800 bg-neutral-950 px-4 py-3">
      <div className="flex items-end gap-2 max-w-3xl mx-auto">
        <textarea
          ...
          placeholder={
            isListening ? "Escuchando..." : "Escribeme o hablame..."
          }
          disabled={disabled}
          rows={1}
          className={`flex-1 bg-neutral-900 text-neutral-200 placeholder-neutral-600 border rounded-xl px-4 py-3 text-sm resize-none focus:outline-none transition-colors disabled:opacity-50 ${
            isListening
